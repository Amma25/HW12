    ...
    (()=>{
        ...
        const r = function(n) {
          ...
          , a = function(n) {
            ...
            }, a ? e.createElement("td", null, r) : e.createElement("td", {
                className: "text-red"
            }, r), e.createElement("td", null, l))
        }
          , o = function(n) {
            var t = n.products
              , r = n.filterText
              ...
              , u = t.filter((function(e) {
                var n = -1 !== e.name.toLowerCase().indexOf(r.toLowerCase())
                  , t = !o || e.stocked;
                return n && t
            }
            )).reduce((function(n, t) {
                var r = t.category !== n.lastCategory;
                return n.output.push(r ? e.createElement(l, {
                    key: t.category,
                    category: t.category
                }) : e.createElement(a, {
                    key: t.name,
            ...
            }, e.createElement("thead", null, e.createElement("tr", null, e.createElement("th", null, "Name"), e.createElement("th", null, "Price"))), e.createElement("tbody", null, u.output))
        }
          , u = [{
            category: "Fruits",
            price: "$1",
        ...
        const c = function() {
          ...
          , f = function() {
            return e.createElement(e.Fragment, null, e.createElement(c, null))
        };
        var d = t(379)
          , p = t.n(d)
          , m = t(795)
